            ...
            <div class="card organizationCard d-flex flex-row">
                ...
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2 d-md-block">
                        <a class="btn btn-warning" href="{{ route('register.organization', $item->id) }}">Daftar</a>
                        <a class="btn btn-outline-primary" href="/images/organizationdetail.pdf" target="_blank">Detail</a>
                      </div>
                </div>
            </div>
            @endforeach
